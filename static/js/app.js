document.addEventListener("DOMContentLoaded",()=>{
  ...
  const bookingChart=(id,d)=>{const el=document.getElementById(id);if(el)new Chart(el,{type:"line",data:{labels:d.labels,datasets:[{data:d.values,borderColor:"#4676f2",backgroundColor:"rgba(70,118,242,.12)",fill:true,tension:.35,pointRadius:2,borderWidth:2}]},options:base})};
  bookingChart("dailyBookingsChart",data.daily_bookings);bookingChart("monthlyBookingsChart",data.monthly_bookings);
