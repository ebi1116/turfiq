...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        BusinessSettings.objects.update_or_create(owner=user, defaults={"business_name":"Greenfield Arena","monthly_revenue_goal":Decimal("180000")})
